...
from src.data import load_local_universe, load_market_bundle, search_securities
...
with st.container(border=True):"""Stock Decision Pro — mobile-first bilingual Streamlit application."""
...
with st.container(border=True):
    ...
    custom_query = ""
    if selected_search:
        selected_symbol = symbol_by_label.get(selected_search, "")
...
if analyze_clicked:
    fallback_symbol = custom_query.upper() if ticker_like(custom_query) else ""

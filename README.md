...
This V1.1 uses `yfinance`/Yahoo Finance for prototyping. It is convenient but is not a licensed commercial market-data feed. Before charging users or relying on real-time execution:
...
هذه النسخة جاهزة للنشر على Streamlit Community Cloud وتعمل على الآيفون والكمبيوتر. تعرض قرارًا سريعًا أولًا، وتضيف مركز تقييم تاريخي محافظ للمضاربة مع سجل الصفقات ومنحنى الأداء ومقارنة SPY. التطبيق أداة بحث وتعليم، وليس توصية مالية شخصية أو ضمانًا للربح. قبل الاستخدام التجاري يجب ربط مزود بيانات سوق مرخص وقاعدة بيانات دائمة وإجراء اختبارات متعددة الأسهم وتدقيق قانوني مناسب.
